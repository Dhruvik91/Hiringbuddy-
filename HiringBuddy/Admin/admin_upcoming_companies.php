...
$display_sql = " SELECT * FROM admin_upcoming ORDER BY company_date ASC ";
...
<body>
    ...
    <section>
      <nav class="shift">
        <ul>
          ...
          <li>
            <a href="./admin_company_page.php" style="text-decoration: none;padding-bottom: 4px;
  ...
  <div style="width: 90%; margin-left: 4.4rem;" class="mt-4">
    <div style="display: flex;justify-content:space-between;">
      <div style="display: flex;">
        <h5 style="margin: 15px 0px 0px 8px;">
          <a href="./admin_company_page.php" style="text-decoration:none;color:black;">All Companies</a>
        </h5>
        <!-- <h5 style="margin: 15px 0px 0px 8px;"><pre>  |  </pre></h2>  -->
        <h5 style="margin: 15px 0px 0px 40px;padding-bottom: 4px;
              border-bottom-style: solid;
              border-bottom-width: 2px;
              width: fit-content; cursor: pointer;">
          <a href="#" style="text-decoration:none;color:black;">Upcoming Companies</a></h2>
      </div>
      ...
      <div class="top_buttons">
        ...
        <form action="../php/admin_add_up_company.php" method="post">
          <div class="add_popup">
            ...
            <div class="AD_form">
              ...
              <div>
                ...
                <input type="date" name="company_date" id="company_date" placeholder="Select Company Date" required />
              </div>
        ...
        <form action="../php/admin_delete_up_company.php" method="post">
    ...
    <table class="table table-striped" style="width: 50%; margin: 0rem 0rem 0rem 0rem;">
      <thead>
        <tr>
  ...
  <div class="my-5">
    <!-- Footer -->
    <footer class="text-center text-lg-start text-white" style="background-color: rgb(43, 43, 43); margin-top:17rem;">
      <!-- Grid container -->
